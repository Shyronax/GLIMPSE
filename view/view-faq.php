...
<head>
    ...
    ?>
    <title>FAQ - Mille Cultures, Une Origine</title>
</head>
<body>
    <?php 
    ...
    <main>
        <div class="container">
            <h1 class="container__title">Foire aux questions (FAQ)</h1>
            <div class="section">
                <h2 class="section__title">Horaires et accès</h2>
                <ul class="section__list">
                    <li class="section__list-item"><a href="#edition" class="section__list-item-link">Édition</a></li>
                    <li class="section__list-item"><a href="#conception" class="section__list-item-link">Conception - Habillage du site</a></li>
            ...
            <div class="section">
                <h2 class="section__title">Édition</h2>
                <div class="section__container-text">
                    <span id="conception"></span>
                    <p class="section__text">Département Métiers du Multimédia et de l'Internet de l'IUT de Champs-sur-Marne <br>
                    2, rue Albert Einstein <br>
                    77420 Champs-sur-Marne, France </p>
                    <a href="tel:0160958585" class="section__link">01 60 95 85 85</a> <br>
                    <a href="mailto:mmi-dir.iut@univ-eiffel.fr" class="section__link">mmi-dir.iut@univ-eiffel.fr</a>
                </div>
            </div>
            <div class="section">
                <h2 class="section__title">Conception - Habillage du site</h2>
                <div class="section__container-text">
                    <span id="hebergement"></span>
                    <p class="section__text">Glimpse <br>
                    2, rue Albert Einstein <br>
                    77420 Champs-sur-Marne, France </p>
                    <a href="tel:0160958585" class="section__link">01 60 95 85 85</a> <br>
                    <a href="mailto:glimpse@yey.fr" class="section__link">glimpse@yey.fr</a>
                </div>
            </div>
            <div class="section">
            ...
            <div class="section">
                ...
                <div class="sub-section">
                    <h3 class="sub-section__title">Puis-je me faire rembourser mon billet ?</h3>
                ...
                <div class="sub-section">
                    <h3 class="sub-section__title">Quels sont les moyens de paiement autorisés ?</h3>
                ...
                <div class="sub-section">
                    <h3 class="sub-section__title">Dois-je imprimer mon billet ?</h3>
            ...
            <div class="section">
                <h2 class="section__title">Pendant la visite</h2>
                <div class="sub-section">
                    <h3 class="sub-section__title">Ai-je le droit de prendre des photos ?</h3>
                ...
                <div class="sub-section">
                    <h3 class="sub-section__title">Puis-je venir avec une valise ?</h3>
                ...
                <div class="sub-section">
                    <h3 class="sub-section__title">Puis-je déposer un sac pendant ma visite ?</h3>
                ...
                <div class="sub-section">
                    <h3 class="sub-section__title">Est-ce possible de sortir et entrer plusieurs fois dans la même journée avec mon billet ?</h3>
                ...
                <div class="sub-section">
                    <h3 class="sub-section__title">Ai-je le droit de dessiner dans les salles ?</h3>
                ...
                <div class="sub-section">
                    <h3 class="sub-section__title">Les animaux sont-ils acceptés ?</h3>
            ...
            <div class="section">
                <h2 class="section__title">Enfants et famille</h2>
                <div class="sub-section">
                    <h3 class="sub-section__title">Faut-il réserver pour les enfants ?</h3>
                    <p class="sub-section__text">Le site de réservation de tickets pour le musée [nom du musée] permet aux utilisateurs de réserver des tickets pour les expositions du musée en ligne. Le site peut également offrir des fonctionnalités supplémentaires pour les utilisateurs inscrits.</p>
                </div>
                <div class="sub-section">
                    <h3 class="sub-section__title">Il y a-t-il des activités pour les enfants ?</h3>
                    <p class="sub-section__text">La création d'un compte utilisateur est facultative et n'est pas nécessaire pour effectuer une réservation. Cependant, si vous choisissez de créer un compte utilisateur, vous devez fournir un login non-utilisé par un autre utilisateur, une adresse e-mail valide et un mot de passe sécurisé. Vous êtes entièrement responsable de la confidentialité de votre mot de passe, de votre compte et ses données. Vous êtes également entièrement responsable de toutes les activités qui se produisent sous votre compte. </p>
                </div>
                <div class="sub-section">
            ...
            <div class="section">
                <h2 class="section__title">Accompagner son groupe</h2>
                <div class="sub-section">
                    <h3 class="sub-section__title">Puis-je réserver pour une trentaine de personnes ?</h3>
                    <p class="sub-section__text">Le site de réservation de tickets pour le musée [nom du musée] permet aux utilisateurs de réserver des tickets pour les expositions du musée en ligne. Le site peut également offrir des fonctionnalités supplémentaires pour les utilisateurs inscrits.</p>
                </div>
                <div class="sub-section">
                    <h3 class="sub-section__title">Pouvons-nous faire une pause ou déjeuner sur place avec mon groupe ?</h3>
                    <p class="sub-section__text">La création d'un compte utilisateur est facultative et n'est pas nécessaire pour effectuer une réservation. Cependant, si vous choisissez de créer un compte utilisateur, vous devez fournir un login non-utilisé par un autre utilisateur, une adresse e-mail valide et un mot de passe sécurisé. Vous êtes entièrement responsable de la confidentialité de votre mot de passe, de votre compte et ses données. Vous êtes également entièrement responsable de toutes les activités qui se produisent sous votre compte. </p>
                </div>
                <div class="sub-section">
                    <h3 class="sub-section__title">Mon groupe comprend une personne en situation de handicap. Où et comment puis-je être aidé ?</h3>
                    <p class="sub-section__text">Pour réserver des tickets pour une exposition, vous devez sélectionner la date l'heure de visite, ainsi que le nombre de tickets par catégories (plein tarifs, moins de 26 ans, enfants de moins de 10 ans). Vous devez ensuite remplir une adresse email de réservation avec confirmation de l'adresse (remplies automatiquement dans le cas d'une connexion à un compte).</p>
                </div>
                <div class="sub-section">
                    <h3 class="sub-section__title">Quels sont mes droits et mes devoirs lors de la visite en tant que responsable de groupe ?</h3>
                    <p class="sub-section__text">La vente de billets pour un musée ou de prestations liées à celui-ci est assimilée à une vente de services de loisirs et, conformément aux articles L 221-28° et L 121-21-8-12° du Code de la consommation, n'ouvre aucun droit au délai de rétractation. <span class="text--bold">Ainsi, les billets ne sont échangeables, ni modifiables, ni remboursables dans le cas où nos établissements sont ouverts au public.</span>
                </div>
                <div class="sub-section">
                    <h3 class="sub-section__title">Quand puis-je réserver ? Combien de temps avant la visite dois-je réserver ?</h3>
                    <p class="sub-section__text">L'ensemble des médias et contenus présents sur ce site web et créés en interne par ses concepteurs et son éditeur, tels que les textes, les images, les vidéos, les sons, les logos ou graphiques, ainsi que leur mise en page, leur organisation et leur présentation, sont la propriété exclusive de l'éditeur ou de ses partenaires, et sont protégés par les lois relatives à la propriété intellectuelle en vigueur.</p>
                </div>
            </div>
        </div>
