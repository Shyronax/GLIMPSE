            ...
            <div class="flex">
                <div class="main-container">
                    <div class="section">
                        ...
                        <p class="section__text">Cette exposition est une présentation de l'histoire fascinante, de la culture et de la vie quotidienne des <span class="text--highlight">peuples Pueblos amérindiens</span> qui habitent les villages traditionnels du Sud-Ouest des États-Unis.</p>
                        ...
                        <p class="section__text">Vous serez plongé dans une <span class="text--highlight">immersion complète</span> de l'univers des Pueblos, mettant en lumière leur riche patrimoine culturel, leur artisanat renommé, leur architecture unique, leur agriculture durable et leur spiritualité profonde. Des <span class="text--highlight">artefacts et des objets d'art exceptionnels</span> vous permettront d'explorer leurs traditions artistiques, notamment leurs célèbres poteries, tissages et bijoux.</p>
                    ...
                    <div class="section">
                        ...
                        <p class="section__text">Ponito & Kohana doivent <span class="text--highlight">décorer le vase avec des symboles</span>, mais ils ne s'en souviennent plus. Ils ont besoin de ton aide pour dessiner les symboles ! </p>

                        <p class="section__text">Pour cela, vous devrez <span class="text--highlight">relier les points</span> entre eux dans le bon ordre afin de reconstituer les symboles que vous verrez durant l'exposition.</p>
                    </div>
                </div>
